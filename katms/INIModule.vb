...
Module INIModule
    '스토어는 앱데이터 폴더에다가!
    Public ReadOnly ININame As String = "katms"
...
#Region "INI 관련 함수들"
    ...
    Public Function SetINI(strKey As String, strValue As String, Optional strAppName As String = "katms") As Boolean
        SetINI = WritePrivateProfileString(strAppName, strKey, strValue, ININamePath)
    End Function

    Public Function GetINI(strKey As String, Optional strAppName As String = "katms") As String
